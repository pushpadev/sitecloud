    ...
    <>
      <Router>
        <Routes>
          ...
          <Route element={<ProtectedRoutes />}>
            <Route exact path="/managesite" element={<ManageSite />} />
          </Route>
          <Route element={<ProtectedRoutes />}>
            <Route exact path="/managesite/:id" element={<ManageSite />} />
          </Route>
          <Route element={<ProtectedRoutes />}>
            <Route exact path="/accountSetting" element={<AccountSettings />} />
          </Route>
