...
const MarkerMap = forwardRef((props, ref) => {
  ...
  const onStyleLoaded = (map) => {
    ...
    const geocoder = new MapboxGeocoder({
      ...
      accessToken:
        "pk.eyJ1IjoiZmFrZXVzZXJnaXRodWIiLCJhIjoiY2pwOGlneGI4MDNnaDN1c2J0eW5zb2ZiNyJ9.mALv0tCpbYUPtzT7YysA2g", // Set the access token
  ...
  useImperativeHandle(ref, () => ({ goToSelectedSite, goToInitialPos }), [
    mapObj,
  ]);
  ...
  return (
    <div className={classes.root}>
            ...
            return (
              ...
              >
                ...
                >
                  <MapPin
                    isSelec={
                      item?.sitemappingId === siteInfo?.sitemappingId
                        ? true
                        : false
                    }
      ...
      <ColorButton onClick={() => addNewSite()}>Add New Site</ColorButton>
