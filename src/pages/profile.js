            ...
            <div className="figma_font">
                <section className="background_color  p-3 ">
                    ...
                    <div className="setting_address_body mb-3  shadow-lg">
                        <div className="row">
                            <div className="col-1 p-2"><svg width="63" height="68" viewBox="0 0 63 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="col-9 p-3">
                                ...
                                <div className="row">
                                    <div className="col-1"><svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="col-11"> <p className="setting_address_h3 pl-5">1256 William St, Sydney, NSW 2001</p></div>
                                </div>
                                <div className="row pt-1">
                                    <div className="col-1"><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="col-6">  <p className="setting_address_h4 pl-5">companymail@nacc.com</p></div>
                                </div>
                            ...
                            <div className="col-2 p-3">
                                <div className="row">
                                    ...
                                    <div className="col-2"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="col-10 setting_address_editor pl-5"><p >Edit Basic Info</p></div>
                                </div>
                    ...
                    <div className="subricption_plan_body mb-3 shadow-lg ">
                        ...
                        <div className="row pt-4">
                            <div className="col-10 row">
                                <div className="col-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-10"><p className="setting_address_h3 pl-5">Gold Membership</p></div>
                            ...
                            <div className="col-2 p-3">
                                <div className="row">
                                    ...
                                    <div className="col-10 setting_address_editor pl-5"><p >Change Plan</p></div>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-10 row pt-4">
                                ...
                                <div className="col-10"><p className="setting_address_h3 pl-5">****  -  ****  -  ****  -  2147</p></div>
                            ...
                            <div className="col-2 p-3">
                                <div className="row">
                                    ...
                                    <div className="col-10 setting_address_editor pl-5"><p >Edit Card Info</p></div>
                                </div>
                    ...
                    <div className="transction_history_body mb-3 shadow-lg">
                        ...
                        <div>
                            ...
                            <div className="row pt-5">
                                ...
                                <div className="col-10"><p className="setting_address_h3 pl-10">-Monthly Charges</p></div>
                            </div>
                            <hr></hr>
                        </div>
                        <div>
